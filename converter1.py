...
pdfpath = input("Enter the name of your pdf file - please use backslash when typing & give full directory path: ")   #Provide the path for your pdf here
txtpath = input("Enter the name of your txt file - please use backslash when typing & give full directory path: ")   #Provide the path for the output text file  
